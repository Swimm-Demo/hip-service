---
title: Filtering and Returning Patients by Phone Number
---
In this document, we will explain the process of filtering and returning multiple patients based on their phone numbers. This process involves several key steps to ensure accurate and efficient retrieval of patient records.

The flow begins with accessing the demographic records of patients. These records are then processed to create an expression that matches the given phone number. This expression is further refined using logical operations to ensure that all relevant patient records are included. Finally, the refined expression is used to invoke the necessary functions to retrieve and return the filtered patient records.
